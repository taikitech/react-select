   ...
   */
	...
	getStateFromValue: function getStateFromValue(value, options, placeholder) {
		...
		return {
			...
			placeholder: !this.props.multi && values.length ? values[0].label : placeholder || this.props.placeholder,
	...
	filterOptions: function filterOptions(options, values) {
		...
		if (this.props.filterOptions) {
			...
			var filterOption = function filterOption(op) {
				if (_this.props.multi && _.includes(exclude, op.value)) return false;
				if (_this.props.filterOption) return _this.props.filterOption.call(_this, op, filterValue);
				var valueTest = String(op.value),
				    labelTest = String(op.label);
				return !filterValue || _this.props.matchPos === 'start' ? _this.props.matchProp !== 'label' && valueTest.toLowerCase().substr(0, filterValue.length) === filterValue || _this.props.matchProp !== 'value' && labelTest.toLowerCase().substr(0, filterValue.length) === filterValue : _this.props.matchProp !== 'label' && valueTest.toLowerCase().indexOf(filterValue.toLowerCase()) >= 0 || _this.props.matchProp !== 'value' && labelTest.toLowerCase().indexOf(filterValue.toLowerCase()) >= 0;
			};
	...
	buildMenu: function buildMenu() {
		...
		var ops = _.map(this.state.filteredOptions, function (op) {
			...
			var mouseEnter = _this2.focusOption.bind(_this2, op),
			    mouseLeave = _this2.unfocusOption.bind(_this2, op),
			    mouseDown = _this2.selectValue.bind(_this2, op);
